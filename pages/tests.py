...
class TestPages(TestCase):
    ...
    def test_help_page_rendered(self):
        ...
        self.assertEqual(response.context["support_email"], settings.SUPPORT_EMAIL)
    ...
    def test_about_page_rendered(self):
        ...
        self.assertEqual(response.context["admin_name"], settings.SUPPORT_NAME)
        self.assertEqual(response.context["admin_email"], settings.SUPPORT_EMAIL)
        self.assertEqual(response.context["description"], settings.INSTANCE_DESCRIPTION)
